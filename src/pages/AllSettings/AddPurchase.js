...
<div>
<Link to='/Extras'>
  <button className='btn btn-primary add-button' style={{marginLeft:"700px", marginTop:"10px"}}>Back</button>
</Link>
</div>
<form onSubmit={handleSubmit} style={{width:"70%", marginLeft:"280px", marginTop:"-10px"}}>
      ...
      <Box mt={4} display="flex" justifyContent="center">
        <Button variant="contained" type="submit" style={{marginRight:"900px"}}>
          Save
        </Button>
      </Box>
    </form>

...
export default function Extras() {
  ...
  <Box  bgcolor="#fff" component="main" sx={{ flexGrow: 1, pt: 3, pl:3 , mr:5, ml:5  }} >
    ...
    <div className="my-day-container MyDay" style={{backgroundColor:"#bfc4ce",  borderBottom:"5px solid #12aed2", marginLeft:"20px" }}>
...
<Grid item xs={12}>
        ...
        <Typography variant="h5" style={{marginRight:"30px"}}>Add Extra Purchase</Typography> 
        </Box>

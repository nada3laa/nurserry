...
export default function Funding() {
  ...
  <Box  bgcolor="#fff" component="main" sx={{ flexGrow: 1, pt: 3, pl:3 , mr:5, ml:5  }} >
      ...
      <div className="my-day-container "  style={{backgroundColor:"#bfc4ce", borderBottom:"5px solid rgb(217 221 228)",marginLeft:"200px"}}>
    ...
    <div className="my-day-container " style={{backgroundColor:"#bfc4ce",  borderBottom:"5px solid rgb(217 221 228) ", marginLeft:"20px" }}>
    ...
    <div className="my-day-container In MyDay" style={{backgroundColor:"#bfc4ce",borderBottom:"5px solid #12aed2" , marginLeft:"20px" }}>
      <div className="icon-container">
...
<Grid item xs={12}>
        ...
        <Typography variant="h5" style={{marginRight:"30px"}}>Add Funding Grant</Typography> 
        </Box>
